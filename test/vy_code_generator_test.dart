...
void main() {
  ...
  group('Library', () {
    test('simple Library', () {
      var classTest = DartClass('Foo');
      var library = Library()..addElement(classTest);
    ...
    test('Library with fields', () {
      var field = Variable.fromTextualContent("const String fieldTest = 'foo'");
      var classTest = DartClass('Foo');
      var library = Library()..addElement(field)..addElement(classTest);
